import { MapPin, Mail, Check, MessageCircle, Scale, FileText, Users, Building } from 'lucide-react';
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 lg:py-24 bg-slate-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid sm:grid-cols-2 gap-6 text-slate-300 mt-8 max-w-sm mx-auto">
